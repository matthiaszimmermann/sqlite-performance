...
Uses file-based databases with streaming data generation for large datasets.
This version can handle 10M+ rows without running out of memory.
"""
...
NUM_ROWS = 10_000_000
BATCH_SIZE = 10_000  # Insert in batches to manage memory
...
def main():
    """Run all benchmarks."""
    print("SQLite Index Performance Benchmark (File-based)")
    print("=" * 80)
    
    num_rows = NUM_ROWS
    print(f"Inserting {num_rows:,} rows per test (batch size: {BATCH_SIZE:,})")
    print()
